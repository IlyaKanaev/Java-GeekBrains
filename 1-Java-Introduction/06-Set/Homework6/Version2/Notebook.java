...
public class Notebook {
    ...
    public static void main(String[] args) {
        ...
        notebooks.add(new Notebook("Notebook2", 16, 1000, "Windows 10", "Silver"));
        notebooks.add(new Notebook("Notebook3", 4, 256, "Windows 7", "White"));
        notebooks.add(new Notebook("Notebook4", 8, 500, "MacOS", "Silver"));
        notebooks.add(new Notebook("Notebook5", 16, 1000, "Windows 10", "Black"));
    ...
    public static void filterAndPrintNotebooks(Set<Notebook> notebooks, Map<String, String> filterCriteria) {
